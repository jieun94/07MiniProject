...
<input type="hidden" name="reviewTran" value="${purchase.tranNo}" />
<input type="hidden" name="reviewProd" value="${purchase.purchaseProd.prodNo}" />
<input type="hidden" name="reviewBuyer" value="${purchase.buyer.userId}" />
